...
public class BioOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(new StringBuilder("INSERT INTO ").append(BioDataBase.PRODUCTO).append(" VALUES (3,'Cosmeticos','Sombreador', 'Esta es la descripcion del jabon de la descarga',"+ R.drawable.cosmeticos4 +",399.99);").toString());
